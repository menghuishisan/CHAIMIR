...
const ROLE_NAVIGATION: RoleNavigationConfig[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { title: '系统配置', items: [{ name: '租户配置', path: '/school-admin/settings', icon: Settings }, { name: '认证配置', path: '/school-admin/auth-config', icon: Shield }, { name: '审计日志', path: '/school-admin/audit', icon: FileText }, { name: '学校告警', path: '/school-admin/system-alerts', icon: BellRing }, { name: '系统公告', path: '/school-admin/announcements', icon: Megaphone }] },
    ],
  },
  {
    ...ROLE_ROUTES.teacher,
    ...
    groups: [
      { title: '教学', items: [{ name: '课程管理', path: '/teacher/courses', icon: Book }, { name: '批改中心', path: '/teacher/grading', icon: CheckSquare }] },
      { title: '实践', items: [{ name: '实验编排', path: '/teacher/experiments', icon: LayoutTemplate }, { name: '赛事组织', path: '/teacher/contests', icon: Trophy }, { name: '实时监控', path: '/teacher/monitoring', icon: Activity }] },
      { title: '资源', items: [{ name: '题库内容', path: '/teacher/questions', icon: Database }, { name: '试卷组卷', path: '/teacher/exams', icon: FileText }, { name: '漏洞题源转化', path: '/teacher/vulnerabilities', icon: AlertTriangle }, { name: '仿真场景', path: '/teacher/simulations', icon: Network }, { name: '共享资源库', path: '/teacher/shared', icon: Share2 }] },
      { title: '组织与成绩', items: [{ name: '成绩报送', path: '/teacher/grades', icon: Send }, { name: '组织查看', path: '/teacher/organization', icon: Users }] },
    ],
  },
  {
    ...ROLE_ROUTES.student,
    ...
    groups: [
      { title: '学习', items: [{ name: '课程', path: '/student/courses', icon: BookOpen }, { name: '实验', path: '/student/experiments', icon: FlaskConical }, { name: '参赛', path: '/student/contests', icon: Swords }, { name: '仿真', path: '/student/simulations', icon: Network }, { name: '战绩', path: '/student/records', icon: Trophy }] },
      { title: '学业', items: [{ name: '成绩', path: '/student/grades', icon: GraduationCap }, { name: '预警', path: '/student/alerts', icon: AlertTriangle }] },
    ],
  },
]
