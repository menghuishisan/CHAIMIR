...
export const pbftSourceCode = [
  ...
  '  newPrimary.collect(2 * f + 1, VIEW_CHANGE)',
...
export const pbftCodeTrace: CodeTraceDef = {
  ...
  lineMapping: [
    ...
    { line: 7, triggerCondition: 'lastTransition == prepare-certificate', annotation: '准备证书需要 2f+1 匹配准备票。' },
    { line: 9, triggerCondition: 'lastTransition == commit-certificate', annotation: '提交证书需要 2f+1 匹配提交票。' },
    ...
    { line: 17, triggerCondition: 'lastTransition == new-view', annotation: '新主节点收集视图切换证书后恢复安全摘要。' },
  ],
  variableWatch: [
