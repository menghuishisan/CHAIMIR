...
export const hotstuffCodeTrace: CodeTraceDef = {
  ...
  language: 'pseudocode',
  lineMapping: [
    { line: 2, triggerCondition: 'lastTransition == new-view', annotation: '领导者收集各副本 High QC,确定安全扩展点。' },
    ...
    { line: 5, triggerCondition: 'lastTransition == qc', annotation: '达到 BFT 法定人数的投票被聚合成 QC。', highlightStyle: 'success' },
