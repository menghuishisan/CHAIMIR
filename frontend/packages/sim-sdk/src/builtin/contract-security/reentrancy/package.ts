...
export const reentrancySimulation: SimPackage<ReentrancyState> = {
  meta: { code: 'builtin__security-reentrancy', name: '重入攻击与防护推演', category: 'contract-security', version: '1.0.0', summary: '完整推演重入攻击的合法存款、提款外部调用、fallback 回调重入、余额错序更新和重入锁修复。', learningObjectives: ['理解外部调用早于状态更新的风险', '掌握重入攻击调用栈', '观察重入锁和先改状态如何防护'], scaleLimit: { nodes: 64, maxTick: 120, maxEvents: 220 } },
