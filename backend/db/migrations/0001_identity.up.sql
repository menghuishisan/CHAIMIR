...
CREATE POLICY department_tenant_rls ON department USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY major_tenant_rls ON major USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY class_tenant_rls ON class USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY account_tenant_rls ON account USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY account_role_tenant_rls ON account_role USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY account_profile_tenant_rls ON account_profile USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY auth_session_tenant_rls ON auth_session USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY sms_code_tenant_rls ON sms_code USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY activation_code_tenant_rls ON activation_code USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY sso_config_tenant_rls ON sso_config USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY import_preview_tenant_rls ON import_preview USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY import_batch_tenant_rls ON import_batch USING (tenant_id = current_setting('app.tenant_id')::BIGINT);
CREATE POLICY audit_log_tenant_rls ON audit_log USING (tenant_id IS NULL OR tenant_id = current_setting('app.tenant_id')::BIGINT);
