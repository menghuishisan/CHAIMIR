...
type TxStore interface {
	...
	ListAssignmentsByCourse(context.Context, int64, int64, bool, int, int) ([]Assignment, int64, error)
	...
	ClaimJudgeOutbox(context.Context, int64, int32, int32, time.Time, string, time.Time) ([]JudgeOutbox, error)
	ClaimJudgeOutboxAcrossTenants(context.Context, int32, int32, time.Time, string, time.Time) ([]JudgeOutbox, error)
	ExhaustExpiredJudgeOutbox(context.Context, int64, int32, time.Time) (int64, error)
	ExhaustExpiredJudgeOutboxAcrossTenants(context.Context, int32, time.Time) (int64, error)
	CompleteJudgeOutbox(context.Context, int64, int64, string) (JudgeOutbox, error)
	RetryJudgeOutbox(context.Context, int64, int64, int32, string, string) (JudgeOutbox, error)
	...
	ListAnnouncements(context.Context, int64, int64, int, int) ([]Announcement, int64, error)
	...
	CountCourseGrades(context.Context, int64, int64) (int64, error)
	ListStudentGrades(context.Context, int64, int64, string, int, int) ([]CourseGrade, int64, error)
