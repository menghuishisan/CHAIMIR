...
type TxStore interface {
	...
	ListGradeReviews(context.Context, int16, int, int) ([]ReviewDTO, error)
	...
	ListGradeAppeals(context.Context, int16, int, int) ([]AppealDTO, error)
	ListAcceptedAppealsByCourseStudent(context.Context, int64, int64) ([]AppealDTO, error)
	UpdateGradeAppealStatus(context.Context, int64, int16, int64, string) (AppealDTO, error)
	CreateAcademicWarning(context.Context, int64, int64, int64, int64, int16, map[string]any) (WarningDTO, error)
	ListAcademicWarnings(context.Context, int64, int, int) ([]WarningDTO, error)
