...
type Querier interface {
	...
	CompleteManualJudgeTask(ctx context.Context, arg CompleteManualJudgeTaskParams) (JudgeTask, error)
	...
	DequeueJudgeTasks(ctx context.Context, arg DequeueJudgeTasksParams) ([]JudgeTask, error)
	ExhaustExpiredJudgeEventOutbox(ctx context.Context, arg ExhaustExpiredJudgeEventOutboxParams) (int64, error)
	FailExpiredJudgeTasks(ctx context.Context, arg FailExpiredJudgeTasksParams) ([]JudgeTask, error)
	...
	ListRecentJudgeTasksBySubmitterProblem(ctx context.Context, arg ListRecentJudgeTasksBySubmitterProblemParams) ([]JudgeTask, error)
