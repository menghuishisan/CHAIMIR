...
func (s *Service) RegisterRuntime(ctx context.Context, req RuntimeRequest) (Runtime, error) {
	...
	return runtime, s.writeAudit(ctx, 0, 0, 5, "sandbox.runtime.upsert", "runtime", runtime.ID, map[string]any{"code": runtime.Code})
}
...
func (s *Service) UpdateRuntime(ctx context.Context, runtimeID int64, req RuntimeRequest) (Runtime, error) {
	...
	return runtime, s.writeAudit(ctx, 0, 0, 5, "sandbox.runtime.update", "runtime", runtimeID, map[string]any{"code": runtime.Code})
}
...
func (s *Service) RegisterRuntimeImage(ctx context.Context, runtimeID int64, req RuntimeImageRequest) (RuntimeImage, error) {
	...
	return image, s.writeAudit(ctx, 0, 0, 5, "sandbox.image.register", "runtime_image", image.ID, map[string]any{"image_url": image.ImageURL})
}
...
func (s *Service) DisableRuntimeImage(ctx context.Context, runtimeID, imageID int64) (RuntimeImage, error) {
	...
	return disabled, s.writeAudit(ctx, 0, 0, 5, "sandbox.image.disable", "runtime_image", imageID, map[string]any{"runtime_id": runtimeID})
}
...
func (s *Service) RunRuntimeSelftest(ctx context.Context, runtimeID int64) (RuntimeSelftestResponse, error) {
	...
	if auditErr := s.writeAudit(ctx, 0, 0, 5, "sandbox.runtime.selftest", "runtime", runtimeID, map[string]any{"status": status}); auditErr != nil {
...
func (s *Service) RegisterTool(ctx context.Context, req ToolRequest) (Tool, error) {
	...
	return tool, s.writeAudit(ctx, 0, 0, 5, "sandbox.tool.upsert", "tool", tool.ID, map[string]any{"code": tool.Code})
}
...
func (s *Service) UpsertQuota(ctx context.Context, quota TenantQuota) (TenantQuota, error) {
	...
	return out, s.writeAudit(ctx, quota.TenantID, 0, 5, "sandbox.quota.upsert", "tenant_quota", quota.TenantID, nil)
}
