...
var (
	...
	ErrContestContentUnavailable = New("81009", "竞赛题目服务暂时不可用,请稍后重试")
	ErrContestSandboxUnavailable = New("81010", "竞赛环境服务暂时不可用,请稍后重试")
	...
	ErrContestJudgeUnavailable     = New("83006", "提交判定服务暂时不可用,请稍后重试")
	ErrContestEventSubscribeFailed = New("83007", "竞赛事件订阅暂时不可用,请稍后重试")
	ErrContestEventUnmatched       = New("83008", "竞赛事件与提交记录不匹配,请稍后重试")
