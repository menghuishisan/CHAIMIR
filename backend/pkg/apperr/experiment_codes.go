...
var (
	...
	ErrExperimentEngineUnavailable = New("71009", "实验环境服务暂时不可用,请稍后重试")
	...
	ErrCheckpointJudgeUnavailable     = New("74009", "检查点判分服务暂时不可用,请稍后重试")
	ErrExperimentEventSubscribeFailed = New("74010", "实验事件订阅暂时不可用,请稍后重试")
	ErrExperimentEventUnmatched       = New("74011", "实验事件与实例状态不匹配,请稍后重试")
)
